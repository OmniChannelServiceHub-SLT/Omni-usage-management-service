...
// NOTE: no dedicated sample response found for this API in the API Params sheet

function toLegacyResponse(records) {
  if (!records || records.length === 0) {
    return {
      isSuccess: false,
      errorMessege: 'No usage record found for this subscriber in the previous month',
