...
// NOTE: no dedicated sample response found for EnhancedCurrentDailyUsage in the API
// Params sheet, and its exact difference from CurrentMonthsDailyUsage is unclear

function toLegacyResponse(records) {
  if (!records || records.length === 0) {
    return {
      isSuccess: false,
      errorMessege: 'No usage record found for this subscriber today',
